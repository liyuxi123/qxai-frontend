<template>
  <div>
    <button @click="startRecognition">开语音识别</button>
...
export default {
  ...
  methods: {
    ...
    async getWebSocketUrl() {
      ...
      const wsUrl = `ws://182.61.62.45:80/realtime_asr?sn=${this.sn}`;
      return wsUrl;
    },
    ...
    async startMicStreaming() {
      ...
      try {
        ...
        const processor = audioContext.createScriptProcessor(4096, 2, 2); // 4096 为缓冲区大小
